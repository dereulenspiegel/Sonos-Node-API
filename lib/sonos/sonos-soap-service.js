  ...
  Sonos: {
    SonosSoap: {
      ...
      getSessionId: function(args) {
        return {
          getSessionIdResult: sourceManager.getSessionId()
        };
      },
      ...
      getExtendedMetadata: function(args) {
        ...
        if(relatedBrowse !== null && relatedBrowse !== undefined ) {
          result.getExtendedMetadataResult["relatedBrowse"] = relatedBrowse;
        }
        if(relatedText !== null && relatedText !== undefined ) {
          result.getExtendedMetadataResult["relatedText"] = relatedText;
        }
        if(relatedPlay !== null && relatedPlay !== undefined ) {
          result.getExtendedMetadataResult["relatedPlay"] = relatedPlay;
        }
        if(isItemCollection(item)){
      ...
      getLastUpdate: function(args){
        return {
          getLastUpdateResult: {
            ...
            pollInterval: sourceManager.getPollInterval()
          }
        };
      }
    }
